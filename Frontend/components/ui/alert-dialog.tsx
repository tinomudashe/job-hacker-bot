...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-xl px-4 py-2 text-sm font-medium",
      "bg-red-600 text-white shadow-sm transition-all duration-200",
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-xl px-4 py-2 text-sm font-medium",
      "border border-gray-300 bg-white/80 text-gray-700 shadow-sm backdrop-blur-sm transition-all duration-200",
      "hover:bg-gray-50 hover:border-gray-400 hover:scale-105 active:scale-95",
      "dark:border-gray-600 dark:bg-gray-800/80 dark:text-gray-300",
      "dark:hover:bg-gray-700/80 dark:hover:border-gray-500",
